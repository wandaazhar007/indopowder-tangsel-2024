...
export const CartContext = createContext({
  items: [], getProductQuantity: () => { }, addOneToCart: (id: number, name: string, price: number) => { }, removeOneFromCart: (id: number) => { },
...
export function CartProvider({ children }: any) {
  ...
  const contextValue: ContexValueType = { items: cartProducts, getProductQuantity, addOneToCart, removeOneFromCart, deleteFromCart, getTotalCost }
  return (
